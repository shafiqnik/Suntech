...
def make_handler(message_store: List[Dict[str, Any]]):
    """Factory function to create handler class with message_store"""
...
class WebServer:
    ...
    def __init__(self, port: int, message_store: List[Dict[str, Any]]):
        self.port = port
    ...
    def start(self):
        ...
        handler_class = make_handler(self.message_store)
